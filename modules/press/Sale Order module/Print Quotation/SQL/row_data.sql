SELECT
    ...
    [M_USER].[USER_NM] AS [APPROVED_BY],
    [VW].[I_ACTION_DATE] AS [APPROVED_DATE],
...
INNER JOIN [VW_WF_LATEST_APPROVAL_STATUS] [VW]
    ON [VW].[I_REF_DOC_NO] = [QH].[I_QT_NO]

LEFT JOIN [TLN_M_USER_LOG] [M_USER]
    ON [M_USER].[USER_ID] = [VW].[I_ACTION_BY]
