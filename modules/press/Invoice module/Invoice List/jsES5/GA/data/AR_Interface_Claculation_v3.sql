-- ส่วนที่ 1: Sale Material Income (Terminal)
SELECT 
     [VOUCHERNO]
    ,[INVOICENO]     
    ,[I_SONO]
...
FROM (
    SELECT 
        ...
        ,[FG].[I_TYPE]
        ,[FG].[I_ITEM_GROUP]
        ,'102012' AS [DEPTCODE]  -- Terminal only
    ...
    WHERE [IVH].[I_INVOICE_NO] = 'IV2602180001'
      AND [FG].[I_TYPE] = 1  -- Terminal
) AS [MAIN]
...
-- ส่วนที่ 2: Process Income (Other)
SELECT 
     [VOUCHERNO]
    ,[INVOICENO]     
    ,[I_SONO]
