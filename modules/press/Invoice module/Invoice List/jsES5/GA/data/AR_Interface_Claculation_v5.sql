-- 1: Account 40100050 (Sale Material Income) - Terminal
SELECT 
     [VOUCHERNO]
    ,[INVOICENO]     
    ,[I_SONO]
...
-- 2: Account 40100055 (Process Income) - Terminal
SELECT 
     [VOUCHERNO]
    ,[INVOICENO]     
    ,[I_SONO]
...
-- 3: Account 40100050 (Sale Material Income) - Other
SELECT 
     [VOUCHERNO]
    ,[INVOICENO]     
    ,[I_SONO]
...
-- 4: Account 40100055 (Process Income) - Other
SELECT 
     [VOUCHERNO]
    ,[INVOICENO]     
    ,[I_SONO]
